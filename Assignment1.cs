       ...
       */
        ...
        private static bool ArrayStringsAreEqual(string[] bulls_string1, string[] bulls_string2)
        {
            try
            {
                ...
                // string array to single string using join method
                string inputString1 = string.Join("", bulls_string1);
                // string array to single string using join method
                string inputString2 = string.Join("", bulls_string2);
                // condition to check whether the two strings are equal or not
        ...
        */
        ...
        private static int SumOfUnique(int[] bull_bucks)
        {
            ...
            {
                // write your code here
                // output integer to store the result
                int output = 0;
